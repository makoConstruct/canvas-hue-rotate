function hueShiftedCanvas(inputCanvasContext, shift){ //returns a new canvas with the hue rotated by shift. Units are not degrees, 1 is a full rotation.
...
function hueShiftCanvas(subjectCanvasContext, shift){ //performs the operation in-place
